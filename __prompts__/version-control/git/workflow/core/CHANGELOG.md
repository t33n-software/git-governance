...
|| Ticket Scope | `GOV-102` |
|| Current HEAD Commit Hash | `69a7b981e7793cc8768a948078a8502ff7157d95` (pre-finalization evidence; the new version entry is intentionally not committed yet) |
...
|| 8 | `prompt.md` | Portable core workflow |
|| 9 | `DESCRIPTION.md` | Root description TOC |
|| 10 | `CONVENTIONS.md` | Authoring and runtime constraints |
