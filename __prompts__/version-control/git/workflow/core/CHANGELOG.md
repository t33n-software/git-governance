...
|| Ticket Scope | `GOV-113` |
|| Current HEAD Commit Hash | `5399e7b6c56473a12df09cd3fa898a668df1d3ba` (pre-finalization evidence; the new version entry is intentionally not committed yet) |
...
|| 10 | `prompt.md` | Portable core workflow |
|| 11 | `DESCRIPTION.md` | Root description TOC |
|| 12 | `CONVENTIONS.md` | Authoring and runtime constraints |
