...
|| Ticket Scope | `GOV-109` |
|| Current HEAD Commit Hash | `3db7d207fba8f304a105b84b1300f1a0cb509500` (pre-finalization evidence; the new version entry is intentionally not committed yet) |
...
|| 9 | `prompt.md` | Portable core workflow |
|| 10 | `DESCRIPTION.md` | Root description TOC |
|| 11 | `CONVENTIONS.md` | Authoring and runtime constraints |
